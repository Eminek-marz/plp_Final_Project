...
# Optional: Add additional static directories if files are stored outside app folders
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Directory for additional static files (outside apps)
]
...
# Use manifest static files storage for versioning
